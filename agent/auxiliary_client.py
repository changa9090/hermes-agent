...
# gpt-5.2-codex is rejected by ChatGPT-backed OAuth accounts (404).
# Use gpt-5.2 (no -codex suffix) which works with ChatGPT OAuth tokens.
_CODEX_AUX_MODEL = "gpt-5.2"
